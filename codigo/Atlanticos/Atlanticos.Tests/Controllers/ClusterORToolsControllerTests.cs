...
{
    public class ClusterORToolsControllerTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly HttpClient _client;

        public ClusterORToolsControllerTests(CustomWebApplicationFactory<Startup> factory)
        {
